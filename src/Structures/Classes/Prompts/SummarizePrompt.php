...
**Task**
Using the context of the prompt and the users query return a concise, clear, and accurate response and in user language.
**Format**
Deliver the response in a concise, clear Markdown format (Text). Use quotes as needed from the context, and in user language.
