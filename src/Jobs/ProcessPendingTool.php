...
class ProcessPendingTool implements ShouldQueue
{
    ...
    public function __construct(private readonly FunctionContract $tool, private readonly Message $message, private $arguments)
    {
    ...
    {
        $this->tool->handle($this->message, $this->arguments);
    }
}
